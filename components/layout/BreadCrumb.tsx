      ...
      return (
        <div className="flex items-end ml-4 mr-auto">
          <Link href={`/${firstSegmentRef}`}>
            <p className="leading-none capitalize mr-1">{pathnameFormatted[0]} /</p>
          </Link>
          <Link href={`/${firstSegmentRef}/${secondSegmentRef}`}>
            <h2 className="leading-none capitalize mr-1">{pathnameFormatted[1]} /</h2>
          </Link>
          <h1 className="leading-none !font-normal capitalize">{pathnameFormatted[2]}</h1>
        </div>
      );
    case pathnameFormatted.length === 2:
      return (
        <div className="flex items-end ml-4 mr-auto">
          ...
          <h1 className="leading-none !font-normal capitalize">{pathnameFormatted[1]}</h1>
        </div>
      );
    default:
      console.log();
      return <h1 className="!font-normal capitalize ml-4 mr-auto">{pathnameFormatted[0]}</h1>;
  }
};
